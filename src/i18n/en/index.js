export default {
  ...
  nav: {
    ...
    contract: {
      deploy: {
        ...
        sublabel: 'Deploy contract to Indexchain'
      },
      my: {
        label: 'My Contracts',
        sublabel: 'Manage contracts on Indexchain',
        view: 'Detail',
        add: 'Add Contract'
      }
    }
  ...
  notify: {
    ...
    flu_downloaded: 'Flu log file(flu.log) already download to desktop,please view by text editor'
  },
  ...
  splash: {
    downloading: {
      title: 'Flu is initializing ...'
    },
    syncing: {
      title: 'Flu is syncing chaindata ...'
    }
  },
  ...
  contract: {
    add: {
      description: 'Add contracts that already deployed to Indexchain to "My Contracts" ',
      name: {
        label: 'Name',
